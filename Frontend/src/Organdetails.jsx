...
function OrganDetails({ selectedOrgan, onSubmit,onBack, selectedpatientID} ) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const dataToSend = { patientId: formData.patientId, lungOption, chiefOption, pastMedicalHistoryOption , substanceAbuseOption};
  
      console.log('Form Data:', dataToSend);
  
      const response = await fetch('http://localhost:5000/add_lung_options', {
        method: 'POST',
        headers: {
  ...
  {showTextField && (
    <div className="row mt-3">
      <div className="col-md-12 offset-md-2">
        <input type="text"style={{border:'1px solid #000',borderRadius:'10px'}} className="form-control" placeholder="Enter Free Text Option" />
      </div>
    </div>
  )}
</div>
      ...
      <div className="col-md-6 ms-4">
        <div className="col-md-12">
          <div className="marital d-flex align-items-center">
            ...
            <label
              className={`maritalcircle p-2 m-3 ${selectedPastMedicalHistory.includes('Drugs') ? 'active' : ''}`}
            >
              <input
                type="checkbox"
                name="pastMedicalHistoryOption"
                value="Drugs"
                style={{ visibility: 'hidden' }}
                checked={selectedPastMedicalHistory.includes('Drugs')}
                onChange={() => handlePastMedicalHistoryChange('Drugs')}
              />
              Drugs &nbsp;&nbsp;
            </label>
            <label
            ...
            {/* <label
              className={`maritalcircle p-2 m-3 ${selectedPastMedicalHistory.includes('Tuberculosis') ? 'active' : ''}`}
            >
              <input
                type="checkbox"
                name="pastMedicalHistoryOption"
                value="Tuberculosis"
                style={{ visibility: 'hidden' }}
                checked={selectedPastMedicalHistory.includes('Tuberculosis')}
                onChange={() => handlePastMedicalHistoryChange('Tuberculosis')}
              />
              Tuberculosis &nbsp;&nbsp;
            </label> */}
...
{selectedOrgan === 'Lungs' && (
  ...
  <div className="form-check form-switch ml-2"  style={{ marginLeft: '15%' }}> {/* Add ml-2 class for spacing */}
    <input
    ...
    />
        ...
        {showSubstanceAbuseOptions && selectedOrgan && (
          <div className="row mt-3">
            <div className="col-md-12">
              <div className="marital d-flex align-items-center">
                {/* Content for Past Medical History Options */}
...
{/* {selectedOrgan === 'Lungs' && selectedPastMedicalHistory.includes('Hyperthyroid') && selectedChiefOptions.includes('Chest Pain') && (
  <div className="container mt-4">
    <p>hii this is the test</p>
      ...
      {selectedOrgan === 'Lungs' && (
      <div className="text-center mt-4" style={{paddingLeft:'60%'}}> {/* Use text-right class here */}
<button
...
<button
  ...
  type="submit" // Change type to "button" if not part of a form
>
  &nbsp;&nbsp; Next &nbsp;&nbsp;
</button>
