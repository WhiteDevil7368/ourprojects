...
function Personaldetails({onSubmit}) {
     ...
     disabled>
          ...
          <div className="col-md-12 mt-4">
            <div className="col-md-6">
              ...
              <div className="form-group mb-4">
                <input type="text" className="form-control inputblocks"  id="firstName" name="firstname" value={formData.firstname} onChange={handleInputChange} placeholder='First Name'  required/>
              </div>
              <div className="form-group mb-4">
                <input type="text" className="form-control inputblocks" id="lastName" name='lastname' value={formData.lastname} onChange={handleInputChange} placeholder='Last Name' required/>
              </div>
              ...
              <div className="input-group mb-3 "  >
                      <input type="text" className="form-control " name='weight'  aria-label="Amount (to the nearest dollar)" value={formData.weight} onChange={handleInputChange}  placeholder="Enter Weight" required/>
 ...
 {/* if above is okay then delete this one */}
      ...
      <div className="container">
        ...
        <div className="text-center mt mb-4-4 rass" > {/* Use text-right class here */}
